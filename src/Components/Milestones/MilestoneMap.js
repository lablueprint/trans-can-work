    ...
    body: [
      {
        ...
        title: require('../../Assets/Images/assessmentTitle.png'),
        id: 'assessment',
        status: true,
      },
      {
        ...
        title: require('../../Assets/Images/online-profileTitle.png'),
        id: 'online-profile',
        status: false,
      },
      {
        ...
        title: require('../../Assets/Images/training-programTitle.png'),
        id: 'training-program',
        status: false,
      },
      {
        ...
        title: require('../../Assets/Images/workshopTitle.png'),
        id: 'workshop',
        status: false,
      },
      {
        ...
        title: require('../../Assets/Images/internshipTitle.png'),
        id: 'internship',
        status: false,
      },
      {
        ...
        title: require('../../Assets/Images/job-fairTitle.png'),
        id: 'job-fair',
        status: false,
      },
      {
        ...
        title: require('../../Assets/Images/job-boardTitle.png'),
        id: 'job-board',
        status: false,
      },
      {
        ...
        title: require('../../Assets/Images/resourceTitle.png'),
        id: 'resource',
        status: false,
      },
      {
        ...
        title: require('../../Assets/Images/hiring-infoTitle.png'),
        id: 'hiring-info',
        status: false,
      },
    ],
